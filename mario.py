...
MARIO_JUMP = 75 * PIXEL_PER_METER
GRAVITY = 1.0 * PIXEL_PER_METER
...
DEBUG_KEY,RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SHIFT_DOWN, SHIFT_UP, SPACE, UP = range(9)
...
class JumpState:
    ...
    def do(mario):
        ...
        mario.y += MARIO_JUMP * game_framework.frame_time - mario.jump_cnt * GRAVITY
...
next_state_table = {
    DashState: {SHIFT_UP:RunState,LEFT_UP:IdleState,LEFT_DOWN:IdleState,RIGHT_UP:IdleState,RIGHT_DOWN:IdleState,SPACE: DashState},

    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState, LEFT_DOWN: RunState,
                SHIFT_UP:IdleState,SHIFT_DOWN:IdleState,SPACE: IdleState,UP:JumpState},

    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SHIFT_DOWN:DashState,SHIFT_UP:RunState,SPACE: RunState, UP:JumpState},

    JumpState: {RIGHT_UP: JumpState, LEFT_UP: JumpState, LEFT_DOWN: JumpState, RIGHT_DOWN: JumpState,
               SHIFT_DOWN:JumpState,SHIFT_UP:JumpState,SPACE: JumpState,UP:JumpState}
}
